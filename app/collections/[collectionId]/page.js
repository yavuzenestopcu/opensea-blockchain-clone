...
// import { useChainId } from 'thirdweb/react'
...
const Collection = () => {
  ...
  useEffect(() => {
    if (!nftModule) return
      ; (async () => {
        const nfts = await (await nftModule.getAll())
  ...
  const marketPlaceModule = useMemo(() => {
    ...
    return sdk.getMarketplaceModule('0xDC102FC0CFa0F0f05f9F07d676d333d0438E16a6')
  }, [provider])
